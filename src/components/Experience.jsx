  ...
  const experiences = [
    {
      ...
      tech: ['Angular', 'TypeScript', 'RxJS', 'NgRx', 'Jest', 'Cypress', 'Microfrontend', 'AWS']
    },
    {
            ...
            >
              ...
              <div className="lg:col-span-3">
                <h3 className="text-base font-semibold text-slate-200 group-hover:text-blue-400 transition-colors duration-300">
                  ...
                  <span className="block sm:inline mt-1 sm:mt-0">{exp.company}</span>
                </h3>
                ...
                <ul className="mt-4 flex flex-wrap gap-2" aria-label="Technologies used">
                  {exp.tech.map((tech, techIndex) => (
                    <li key={techIndex}>
                      <span
                        className="inline-block px-3 py-1 text-xs font-medium text-blue-400 bg-blue-400/10 rounded-full"
                      >
                        {tech}
                      </span>
                    </li>
